defmodule OpsdeskWeb.Layouts do
  @moduledoc """
  ...
  attr :nav_links, :list,
    default: [{"Requests", "/"}, {"Assets", "/"}, {"Directory", "/"}],
    doc: "header nav links as {label, path} tuples"
  ...
  def app(assigns) do
    ...
    <header class="navbar px-4 sm:px-6 lg:px-8 border-b border-base-300">
      <div class="flex-1">
        <a href={~p"/"} class="flex items-center gap-2 w-fit">
          <img src={~p"/images/logo.svg"} width="32" />
          <span class="text-lg font-bold">OpsDesk</span>
        </a>
      </div>
      <div class="flex-none">
    ...
    <footer class="footer footer-center border-t border-base-300 p-6 text-base-content/70">
      <aside>
        <p class="text-sm">
          OpsDesk &copy; {Date.utc_today().year} &middot; Service desk & asset management
        </p>
      </aside>
    </footer>
